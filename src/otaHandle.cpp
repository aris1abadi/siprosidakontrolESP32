...
extern const char *hostName ;                         // You can modify this to your desired host name
...
//                        ESPhttpUpdate.setLedPin(2, LOW);
                        ...
                        t_httpUpdate_return ret = ESPhttpUpdate.update(String(serverAddress) + "/upload/" + urlEncode(hostName) + "_firmware.bin", firmwareVersion);
//#elif defined(ESP32)
